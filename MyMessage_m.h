...
/**
 * Class generated from <tt>MyMessage.msg:9</tt> by opp_msgtool.
 * <pre>
 * message MyMessage
 * {
 *     int hopCount = 0;    // incremented at every router
 *     int ttl = 20;   // decremented at every router; drop when 0
 *     int messageId = 1;   // unique packet ID
 * }
 * </pre>
 */
